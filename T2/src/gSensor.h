...
#define ACCELERATION_ALARM_HIGH_THRESHOLD      (2.0)
#define ACCELERATION_ALARM_LOW_THRESHOLD       (1.0)

#define DECELERATION_ALARM_HIGH_THRESHOLD     (-2.0)
#define DECELERATION_ALARM_LOW_THRESHOLD      (-1.0)
