...
#define RF_POWER_CUTOFF_PORT_NUM          2
#define RF_POWER_CUTOFF_PIN_NUM           4
...
#define GSM_ENABLE_PORT_NUM               1
#define GSM_ENABLE_PIN_NUM                28
...
typedef struct LINE{
	char startChar;
	char endChar;
	void (*callback)(char *buffer, COMMAND_RESPONSE_T *response, const UART_PORT_T *uart_port);
}LINE_T;
