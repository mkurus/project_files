...
#define ENGINE_HOUR_COUNTER_SAVE_INTERVAL         60          /* defines engine hour update interval in secs */
...
typedef enum COVER_STATES_T  { COVER_CLOSED, COVER_OPEN } COVER_STATES;
